...
import source.create_anim_layer as create_ani
...
class CreateAniLayerUI(QDialog):
    def __init__(self, parent = None):
        ...
        #self.selected_caches = ["/home/s5221034/pipeline-project-alesiakarch/maya_test_project/cache/test_rig1_001.usd",
        #                        "/home/s5221034/pipeline-project-alesiakarch/maya_test_project/cache/test_rig2_001.usd"]
        # Open stage
        stage_path = create_ani.usd_utils.get_stage_path()
        stage = Usd.Stage.Open(stage_path)

        caches = create_ani.find_caches(stage_path)
